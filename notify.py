...
try:
    with open(f'{anialert_path}/anime_data.txt', 'r+') as old_data:
        anime_info = json.load(old_data)

    with open(f'{anialert_path}/finished_airing.txt', 'w') as finished_anime:
    ...
    with open(f"{anialert_path}/finished_airing.txt", "r+") as anime_file:
